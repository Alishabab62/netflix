...
const Login = () => {
  ...
  return (
    <div className=''>
        <Header/>
        <div className=''>
            <img src={bgImage} alt="background" className='h-screen w-full absolute'/>
        </div>
        <form className=' absolute bg-black opacity-90 mx-auto left-0 right-0 w-3/12 mt-40  p-6 rounded-lg text-white'>
